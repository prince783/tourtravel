  ...
  return (
    <>
      ...
      <main className="bg-stone-50 text-slate-900">
        ...
        <section className="mx-auto max-w-7xl px-4 py-20 md:px-6">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_1.4fr] lg:items-center">
            <Reveal className="overflow-hidden rounded-[28px] shadow-[0_18px_50px_rgba(15,23,42,0.08)]" direction="left">
              <Image
                src="/abouthome.jpg"
      ...
      <footer className="bg-white">
        <div className="reveal-fade mx-auto max-w-7xl px-4 py-8 text-sm text-slate-600 md:px-6">
